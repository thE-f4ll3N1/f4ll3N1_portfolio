! function(t) {
    ...
    function yt(t) {
        ...
        r.dispatch((0, y.instanceAdded)((0, a.default)({
            ...
            var n = t.getState()
                .ixParameters;
            t.dispatch((0, y.instanceStarted)(e, 0)), t.dispatch((0, y.animationFrameChanged)(performance.now(), n)), It(t.getState()
                .ixInstances[e], t)
        }(r, _) : (P({
            store: r,
            select: function(t) {
        ...
        switch (n.actionTypeId) {
            ...
            case st:
                var I = n.config,
                    ...
                    A = I.aValue;
                return {
                    rValue: T, gValue: O, bValue: b, aValue: A
                };
            case it:
                    ...
                    switch (r.actionTypeId) {
                        ...
                        case st:
                            var h = pt[r.actionTypeId],
                                ...
                                g = n.aValue;
                            Mt(t, h, o), a(t, h, g >= 1 ? "rgb(".concat(E, ",")
                                .concat(_, ",")
                                .concat(y, ")") : "rgba(".concat(E, ",")
                                .concat(_, ",")
                                .concat(y, ",")
                                .concat(g, ")"));
                            break;
    ...
    function mt(t) {
        ...
        return null == x || null == C ? [] : y.IS_BROWSER_ENV && u ? d(C)
            .filter(function(t) {
                return u.contains(t)
            }) : N === G ? d(x, C) : N === X ? p(d(x))
            .filter(E(C)) : N === V ? h(d(x))
            .filter(E(C)) : d(C)
    }
    var It = /px/,
        Tt = function(t, e) {
    ...
    function Mt(t, e, n) {
        if (y.IS_BROWSER_ENV) {
            ...
            if (r) {
                ...
                if (a) {
                    var u = a.split(H)
                        .map(dt); - 1 === u.indexOf(r) && o(t, B, u.concat(r)
                        .join(H))
                } else o(t, B, r)
            }
        }
        ...
        if (y.IS_BROWSER_ENV) {
            ...
            if (r) {
                var i = n.getStyle,
                    o = n.setStyle,
                    a = i(t, B);
                a && -1 !== a.indexOf(r) && o(t, B, a.split(H)
                    .map(dt)
                    .filter(function(t) {
                        return t !== r
                    })
    ...
    .init({
        "events": {
            "e": {
                ...
                "mediaQueries": ["main"],
                "target": {
                    "id": "63ebb850e80a6fae0a328d4f|f404d571-2675-f3df-625f-6d9991eead7e",
                    "appliesTo": "ELEMENT",
                    "styleBlockIds": []
                },
                "targets": [{
            ...
            "e-3": {
                ...
                "target": {
                    "selector": ".heading",
                    "originalId": "63ebb850e80a6fae0a328d4f|0dc5a312-f35a-175f-0c8c-cdbdca153edf",
                    "appliesTo": "CLASS"
                },
                "targets": [],
                "config": {
        ...
        "actionLists": {
            ...
            "a-3": {
                ...
                "actionItemGroups": [{
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "target": {
                                "useEventTarget": true,
                                "id": "63ebb850e80a6fae0a328d4f|0dc5a312-f35a-175f-0c8c-cdbdca153edf"
                            }
                        }
                    }, {
                        "id": "a-3-n-3",
                ...
                "createdOn": 1676719746552,
                "useFirstGroupAsInitialState": true
            },
            "a-4": {
                "id": "a-4",
                "title": "text-animate-out",
                "actionItemGroups": [{
                    "actionItems": [{
                        "id": "a-4-n-2",
                        "actionTypeId": "STYLE_TEXT_COLOR",
